    ...
    <section className="project-header">
      <div className="project-header-content">
        <div className="project-header-top-container">
          ...
          <p className="project-header-description">{module.component.description}</p>
        </div>
        ...
        <div className="project-header-lower-container">
          <div className="partnership-box">
            ...
            <div className="partnership-text">{module.component.partnership}</div>
          </div>
      ...
      <div className="project-header-image-box">
        {module.component.headImg ? 
          <img className="project-header-image" src={module.component.headImg[process.env.REACT_APP_IMAGE_USED]}/>
          :
