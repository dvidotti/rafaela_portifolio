...
const Header = props => {
    ...
    return (
        <section
            className={
                history === '/' ? 'header-container-home' : 'header-container'
            }
        >
            <section className="header-top-container">
                ...
                <div className="text-two-container">
                    <span
                        className={
                            history === '/'
                                ? 'text-two-header-home'
                                : 'text-two-header'
                        }
                    >
                        {' '}
                        Experienced in Strategy, Brand, Graphic<br /> and
                        Digital Design
                    </span>
                </div>
                <div className="arrow-down-outer-container">
                    <div
                        className={
                            history === '/'
                                ? 'arrow-down-inner-container-home'
                                : 'arrow-down-inner-container'
                        }
                    >
                    ...
                    <div className="header-right-container">
                        ...
                        >
                            <span className={'about-menu-home'}>
                                <span className="hover-bottom-border">
                                    ADMIN
                                </span>
                            </span>
                        </Link>
