                ...
                <div style={{ display: 'flex' }}>
                    <div className="project-box-input">
                        <div className="horizontal-input">
                            <label className="horizontal-label" htmlFor="name">
                                Name
                            </label>
                            <input
                                id="name"
                        ...
                        <div className="horizontal-input">
                            <label className="horizontal-label" htmlFor="type">
                                Type
                            </label>
                            <input
                                id="type"
                    ...
                    <div className="project-box-input">
                        <div className="horizontal-input">
                            <label className="horizontal-label" htmlFor="areas">
                                Areas
                            </label>
                            <input
                                id="areas"
            ...
            <section className="bottom-control-container">
                ...
                <div>
                    <select
                        ...
                        defaultValue={
                            selectedComponent.onComponent || 'ProjectHeaders'
                        }
                    >
